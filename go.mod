module github.com/Sion-L/scheculer-demo
...
require (
	...
	k8s.io/api v0.19.9 // indirect
	k8s.io/apimachinery v0.19.9 // indirect
	k8s.io/apiserver v0.19.9 // indirect
	k8s.io/client-go v0.19.9 // indirect
	k8s.io/cloud-provider v0.19.9 // indirect
